...
export default function Schedule() {
    ...
    return (
        <div id="main-content"
            className="p-10 relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
                            ...
                            <div className="mt-3 sm:pr-8">
                                ...
                                {data.getSchedule.Materials.map((material) => {
                                    if (material.day === 1 && material.session === 'morning') {
                                        return (<p className="mb-2 text-base font-normal text-gray-500 dark:text-gray-400">{material.title}</p>)
                                    }
                                })}
                                <time
                                ...
                                {data.getSchedule.Assignments.map(assignment => {
                                    if (assignment.day === 1) {
                                        return (<p className="text-base font-normal text-gray-500 dark:text-gray-400">{assignment.title}</p>)
                                    }
                                })}
                            </div>
                        </li>
