                ...
                <div className="flex justify-between items-center">
                    <div className="flex justify-start items-center">
                        ...
                        <a href="#" className="flex mr-14">
                            <img src="https://statics.hacktiv8.com/images/logo/hacktiv8-light.webp" className="mr-3 h-8"
                                alt="FlowBite Logo" />
                        </a>
                        <form action="#" method="GET" className="hidden lg:block lg:pl-2">
                            <div className="flex">
                                <label htmlFor="batches" className="sr-only">Choose a batch</label>
                                <select id="batches"
                                    className="pr-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-l-lg border-r-gray-100 dark:border-r-gray-700 border-r-2 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected>Choose a batch</option>
                                    <option value="hck-49-witty-fox">HCK 49 Witty Fox</option>
                                    <option value="hck-49-xenia-fox">HCK 50 Xenia Fox</option>
                                </select>
                                <button id="phase-button" data-dropdown-toggle="dropdown-phase"
                                    className="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-500 bg-gray-100 border border-gray-300 rounded-r-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600"
                                    type="button">
                                    Choose phase <svg aria-hidden="true" className="ml-1 w-4 h-4" fill="currentColor"
                                        viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd"
                                ...
                                <div id="dropdown-phase"
                                    className="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
                                    <ul className="py-1 text-sm text-gray-700 dark:text-gray-200"
                                        aria-labelledby="phase-button">
                                        <li>
                                            <button type="button"
                                ...
                                <a href="#" className="flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <div className="pl-3 w-full">
                                        <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400"><span
                                            className="font-semibold text-gray-900 dark:text-white">Beliau</span>
                                            posted a new announcement: Besok kantin tutup.
                                        </div>
                                ...
                                <button type="button"
                                    ...
                                    <div
                                        ...
                                        <svg className="absolute -left-1 w-12 h-12 text-gray-400" fill="currentColor"
                                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd"
                                                d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd">
                                            </path>
                                        </svg>
                                    </div>
                                </button>
